# 🚀 Advanced AI-Powered Job Search Platform

**Multi-Source Semantic Search with Cross-Encoder Reranking**

This is a production-ready, intelligent job discovery platform that revolutionizes how skilled professionals find their next opportunity. Instead of manually checking multiple job boards, this system provides a single, powerful interface with advanced AI capabilities.

## 🌟 What Makes This Special

**🧠 Two-Stage Search Architecture:**
1. **Broad Candidate Selection**: Semantic vector search across multiple job boards
